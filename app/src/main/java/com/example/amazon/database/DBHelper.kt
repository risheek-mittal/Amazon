...
//    override fun DataBaseH
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val query = ("CREATE TABLE " + TABLE_NAME + " ("
                + ID_COL + " INTEGER PRIMARY KEY, " + TITLE_COL + " TEXT, " + QUANTITY_COL + " TEXT, " + PRICE_COL + " TEXT " + ");")
        println(query)
...
//                ")", null)]
    ...
    fun addName(name : String, age : String, quantity : String ){
    ...
    @SuppressLint("Range")
    fun addQuantity(cartList : List<String>, title : String, price : String, quantity: String){
        val values = ContentValues()
        var id = ""
        val db = this.writableDatabase
        // we are inserting our values
...
//        db.insert(TABLE_NAME, null, values)
    ...
    companion object{
        ...
        private val DATABASE_NAME = "AMAZONAPP"
